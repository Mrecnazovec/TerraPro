...
function showMenu(el) {
	...
	document.querySelector('.i-overlay').classList.add('show')
}

function hideMenu(el) {
	document.querySelector(`.${el}`).classList.remove('show')
	document.querySelector('.i-overlay').classList.remove('show')
}
...
// promo slider
const prmoSlider = new Swiper('.i-promo-swiper .swiper', {
	slidesPerView: 1,
	preloadImages: false,
	lazy: {
		enabled: true,
...
const grid = document.querySelector('.i-grid')
